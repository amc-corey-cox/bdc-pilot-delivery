...
# dbGaP: phs000286
# Version: v7, Consent: c4 (DS-FDO-IRB)
#
...
DM_INPUT_DIR         := /sbgenomics/workspace/output/JHS_cleaned/JHS-v7-c4
DM_RAW_SOURCE        := /sbgenomics/project-files/PilotParentStudies/JHS/JHS-v7-c4
DM_SCHEMA_NAME       := JHS_v7_c4
DM_OUTPUT_DIR        := /sbgenomics/workspace/output/JHS/Schema_JHS_v7_c4
...
DM_MAPPING_POSTFIX   := -DS-FDO-IRB-data
