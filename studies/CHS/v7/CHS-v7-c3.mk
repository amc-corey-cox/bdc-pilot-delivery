...
DM_INPUT_DIR         := /sbgenomics/workspace/output/CHS_cleaned/CHS-v7-c3
DM_RAW_SOURCE        := /sbgenomics/project-files/PilotParentStudies/CHS/parent-CHS_DS-CVD-MDS_-phs000287-v7-p1-c3
