...
DM_INPUT_DIR         := /sbgenomics/workspace/output/CHS_cleaned/CHS-v7-c1
DM_RAW_SOURCE        := /sbgenomics/project-files/PilotParentStudies/CHS/parent-CHS_HMB-MDS_-phs000287-v7-p1-c1
DM_SCHEMA_NAME       := CHS_v7_c1
DM_OUTPUT_DIR        := /sbgenomics/workspace/output/CHS/Schema_CHS_v7_c1
...
DM_MAPPING_POSTFIX   := -HMB-IRB-MDS-data
